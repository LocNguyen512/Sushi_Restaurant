/****** Object:  Database [SUSUSHISHI]   Script Date: 29/11/2024 01:04:32 ******/
...
USE [SUSUSHISHI]
GO
ALTER DATABASE [SUSUSHISHI] SET COMPATIBILITY_LEVEL = 160
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [SUSUSHISHI].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [SUSUSHISHI] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET ARITHABORT OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [SUSUSHISHI] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [SUSUSHISHI] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [SUSUSHISHI] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET  ENABLE_BROKER 
GO
ALTER DATABASE [SUSUSHISHI] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [SUSUSHISHI] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [SUSUSHISHI] SET  MULTI_USER 
GO
ALTER DATABASE [SUSUSHISHI] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [SUSUSHISHI] SET DB_CHAINING OFF 
GO
ALTER DATABASE [SUSUSHISHI] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [SUSUSHISHI] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [SUSUSHISHI] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [SUSUSHISHI] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [SUSUSHISHI] SET QUERY_STORE = ON
GO
ALTER DATABASE [SUSUSHISHI] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [SUSUSHISHI]
GO
...
GO
ALTER DATABASE [SUSUSHISHI] SET  READ_WRITE 
GO